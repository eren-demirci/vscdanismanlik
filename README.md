This is a [Next.js](https://nextjs.org) project styled with Tailwind CSS and a project with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).
