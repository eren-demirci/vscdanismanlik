          ...
          <div className="grid grid-cols-12 gap-1">
            {imageUrl && (
              <div className="col-span-12 lg:col-span-6">
                <div
                  className="contact-media radius18"
                  data-aos="fade-right"
            ...
            <div className="col-span-12 lg:col-span-6">
              <div className="contact-form-wrap">
                ...
                <Form cls="form contact-form" onSubmitHandler={handleSubmit}>
                  <TextField
                    wrapperCls="w-half"
                    cls="text-16"
                ...
                {status === "success" && (
                  <p className="text-16 fw-500 text-green-600 !mt-1">
                    {message}
                  </p>
                )}
